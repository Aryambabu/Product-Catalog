...
<body>
    ...
    <div class='bg-light'>
<div class="container mt-5 pt-5" style="max-width:1200px; margin: auto; margin-top:150px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>Applications</h3>
        <a href="add_app.php" class="btn btn-success">Add Application</a>
    </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_app.php?id=<?=$row['id']?>" class="btn btn-sm btn-warning">Edit</a>
                        <a href="delete_app.php?id=<?=$row['id']?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete app?')">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
